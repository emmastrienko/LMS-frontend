        ...
        <div>
          {data[activeVideo]?.links.map((item: any, index: number) => (
            <div key={index} className="mb-5">
              <h2 className="800ppx:text-[20px] 800px:inline-block dark:text-white text-black">
        ...
        <>
          <div className="flex w-full">
            ...
            <textarea
              ...
              className="outline-none bg-transparent ml-3 border border-[#ffffff57] 800px:w-full p-2 rounded w-[90%] 800px:!text-[18px] text-Poppins"
            ></textarea>
          </div>
            ...
            <>
              <div className="w-full flex relative dark:text-white text-black">
                <input
                  ...
                  className={`block 800px:ml-12 mt-2 outline-none bg-transparent border-b dark:border-[#fff] border-[#00000027] dark:text-white text-black p-[5px] w-[95%] ${
                    answer === "" ||
