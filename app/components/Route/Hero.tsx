    ...
    <div className="w-full 1000px:flex items-center">
      ...
      <div className="1000px:w-[60%] flex flex-col items-center 1000px:mt-[0px] text-center 1000px:text-left mt-[150px]">
        ...
        <div className="1500px:w-[55%] 1100px:w-[76%] w-[90%] flex items-center">
          <Image src={clientImg1} alt="" className="rounded-full ml-[-20px]" />
          <Image src={clientImg2} alt="" className="rounded-full ml-[-20px]" />
          <Image src={clientImg3} alt="" className="rounded-full ml-[-20px]" />
